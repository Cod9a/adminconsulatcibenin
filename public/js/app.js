...
/* harmony import */ var _components_MeetingsIndex__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/MeetingsIndex */ "./resources/js/components/MeetingsIndex.js");
/* harmony import */ var _components_DemandsIndex__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/DemandsIndex */ "./resources/js/components/DemandsIndex.js");
/* harmony import */ var _components_WaitingQueueItemsIndex__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/WaitingQueueItemsIndex */ "./resources/js/components/WaitingQueueItemsIndex.js");
...
window.createPopper = _popperjs_core__WEBPACK_IMPORTED_MODULE_4__.createPopper;
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data("meetingsIndex", _components_MeetingsIndex__WEBPACK_IMPORTED_MODULE_1__["default"]);
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data("demandsIndex", _components_DemandsIndex__WEBPACK_IMPORTED_MODULE_2__["default"]);
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data("waitingQueueItemsIndex", _components_WaitingQueueItemsIndex__WEBPACK_IMPORTED_MODULE_3__["default"]);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var qr_scanner__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! qr-scanner */ "./node_modules/qr-scanner/src/qr-scanner.js");
...
var tokenVar = document.querySelector('meta[name="csrf-token"]');

if (tokenVar) {
  window.axios.defaults.headers.common["X-CSRF-TOKEN"] = tokenVar.getAttribute("content");
}
...
/***/ "./resources/js/components/DemandsIndex.js":
/*!*************************************************!*\
  !*** ./resources/js/components/DemandsIndex.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function (indexUrl) {
  return {
    ...
    getI: function getI(period) {
      var _this5 = this;

      this.q = '';
      this.tab = period;
      axios__WEBPACK_IMPORTED_MODULE_0___default().get("".concat(indexUrl, "/").concat(period)).then(function (result) {
        _this5.demands = result.data.data;
        _this5.prev_link = result.data.prev_page_url;
        _this5.next_link = result.data.next_page_url;
      });
    },
    setSelectedDemand: function setSelectedDemand(demand) {
      this.selectedDemand = demand;
    },
    cancelOutSelectedDemand: function cancelOutSelectedDemand() {
    ...
    updateStatus: function updateStatus(demand, status) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().put("".concat(indexUrl, "/").concat(demand.id), {
        ...
        var selectedDemand = _this6.demands.filter(function (item) {
    ...
    onValidated: function onValidated() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().put("".concat(indexUrl, "/").concat(this.selectedDemand.d_id, "/validate"), {}).then(function (result) {
        _this7.fetchData();

        _this7.selectedDemand = null;

        _this7.$dispatch("notify", {
    ...
    onRejected: function onRejected() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().put("".concat(indexUrl, "/").concat(this.selectedDemand.d_id, "/reject"), {}).then(function (result) {
        _this8.fetchData();

        _this8.selectedDemand = null;

        _this8.$dispatch("notify", {
    ...
    onRejectionConfirmed: function onRejectionConfirmed() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().put("".concat(indexUrl, "/").concat(this.selectedDemand.d_id, "/reject"), {
        justification: this.justificationText
      }).then(function (result) {
        _this9.fetchData();

        _this9.rejectionModal = false;
        _this9.selectedDemand = null;
        _this9.justificationText = "";

        _this9.$dispatch("notify", {
...
/***/ "./resources/js/components/MeetingsIndex.js":
/*!**************************************************!*\
  !*** ./resources/js/components/MeetingsIndex.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function (meetingIndexUrl) {
  return {
    q: "",
    meetings: [],
    prev_link: null,
    ...
    fetchData: function fetchData() {
      ...
      this.loading = true;
      axios__WEBPACK_IMPORTED_MODULE_0___default().get("".concat(meetingIndexUrl)).then(function (result) {
        _this.loading = false;
        _this.meetings = result.data.data;
        _this.prev_link = result.data.prev_page_url;
        _this.next_link = result.data.next_page_url;
      });
    },
    fetchNext: function fetchNext() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().get(this.next_link).then(function (result) {
        _this2.meetings = result.data.data;
        _this2.prev_link = result.data.prev_page_url;
        _this2.next_link = result.data.next_page_url;
      });
    },
    fetchPrev: function fetchPrev() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().get(this.prev_link).then(function (result) {
        _this3.meetings = result.data.data;
        _this3.prev_link = result.data.prev_page_url;
        _this3.next_link = result.data.next_page_url;
      });
    },
    search: function search() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().get("".concat(meetingIndexUrl, "?q=").concat(this.q)).then(function (result) {
        _this4.meetings = result.data.data;
        _this4.prev_link = result.data.prev_page_url;
        _this4.next_link = result.data.next_page_url;
      });
    },
    setDeleted: function setDeleted(meeting) {
      this.deleted = meeting.id;
    },
    sendDeletion: function sendDeletion() {
      var _this5 = this;

      axios__WEBPACK_IMPORTED_MODULE_0___default()["delete"]("".concat(meetingIndexUrl, "/").concat(this.deleted)).then(function (result) {
        _this5.fetchData();

        _this5.deleted = null;

        _this5.$dispatch("notify", {
...
/***/ "./resources/js/components/WaitingQueueItemsIndex.js":
/*!***********************************************************!*\
  !*** ./resources/js/components/WaitingQueueItemsIndex.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  return {
    ...
    fetchData: function fetchData() {
      ...
      axios.get("".concat(indexUrl)).then(function (result) {
        _this.waitingQueueItems = result.data.data;
      });
    }
  };
});
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "32b7d3573a2d4cf09318bfb2de56410c.js");
